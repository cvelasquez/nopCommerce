...
namespace Nop.Plugin.Widgets.SwipeSliderPro.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop.plugins.widgets.swipesliderpro.pictureurl-{0}-{1}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.swipesliderpro";
